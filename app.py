...
def page2():
    st.markdown("Filter by Base, T, Operating Conditions")
    #st.sidebar.markdown("Filter️")


page_names_to_funcs = {
    "Data Distribution": page1,
...
if selected_page == "Data Distribution":
...
# -- streamlit selection
    ...
    st.subheader("1. Filtered by Temperature and Base")
    df
    number_of_result = df.shape[0]
    st.markdown(f'*Available Results: {number_of_result}*')
    ...
    st.subheader('Operating Conditions of the Filtered Data')
